...
**The Parallel Strategy:** Don't dismantle, outcompete. Build alternative structures people can migrate to voluntarily. The old system doesn't need to be destroyed; it needs to become optional. Not exit *instead of* voice, though — Document 3 §5.4 sets out why cheap exit hollows an institution rather than disciplining it, stripping out the members most capable of repairing it. The claim here is narrower: where a legacy system has become unreformable from the inside, a better alternative people can move to is the remaining path, and it has to win on being better rather than on being easier to reach. As parallel systems demonstrate superior coordination, people and institutions migrate incrementally. The legacy system hollows out through attrition rather than revolution.
