...
This also explains why the behavior persists despite being demonstrably costly. In market economics, sustained fitness-reducing behavior should be selected out — agents who make better choices should outcompete those who don't. But in Zahavian dynamics, the costly signal *is* the competitive advantage. You can't outcompete the peacock by being a better flier, because flying isn't what peahens are selecting for. You can't outcompete the luxury-belief holder by having better policy outcomes, because outcomes aren't what the social hierarchy is selecting for. **The signal has decoupled from the substrate it originally tracked — and the selection pressure maintains the signal, not the substrate.**
