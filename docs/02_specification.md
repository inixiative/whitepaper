...
Hamilton's rule (r × B > C) explains the genetic precondition: eusociality becomes stable when relatedness is high enough that helping the colony *is* helping your genes. But genetics only opens the door. What *maintains* eusocial coordination is the signaling substrate—pheromones, tactile communication, shared chemical environment. Destroy the pheromone network and the colony doesn't gradually become less cooperative; it *disintegrates*. Workers stop working. Soldiers stop defending. The superorganism dies the same way a body dies when bioelectric signaling fails: not through destruction of parts, but through loss of the substrate that made parts into a whole.
