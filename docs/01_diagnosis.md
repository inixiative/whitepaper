...
**This pattern exists at multiple scales.** Principal-agent misalignment isn't unique to governance—it appears wherever decision-makers face different time horizons than those affected by decisions. Your brain defects against your body's long-term health by pursuing short-term pleasure. Cells then "learn" insulin resistance—downregulating receptors to protect against chronic high-voltage signals, a locally rational response that creates system-level catastrophe. The same dynamic appears in governance: when populations are bombarded with constant regulatory noise, they develop civic signal resistance (apathy), and the system responds by increasing volume rather than improving fidelity. The result is metabolic: citizens stop listening not from laziness but from self-protection, while the system interprets this resistance as justification for even more signal intensity.
