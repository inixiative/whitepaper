...
**The stopping rule is purchased by external threat, not by sex.** The terminus exists because an enemy exists. Remove intergroup competition and the rival's coalition value goes to zero for everyone, at which point exclusion becomes rational irrespective of composition. Vehicle-perception depends on the same condition: remove the outgroup and the institution ceases to be a vehicle for anyone. This is the same mechanism §1.13 identifies in governance systems that lose competitive pressure, and it is reached here by two independent routes—the retention rule and the perceptual layer—which is worth something. An institution that stops perceiving an outside adversary converges on the exclusion repertoire whoever staffs it.
