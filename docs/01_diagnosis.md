...
**What predicts which outcome—a hypothesis worth testing.** If roughly a quarter of crises resolve by negotiation, the obvious question is what distinguishes those cases. The candidate variable is not position within a generational cycle but **the experiential proximity of the cohort holding power to catastrophic failure**.

The negotiated cases share it. The English elite of 1688 had lived through civil war and a regicide. The Meiji reformers had just watched China dismembered in the Opium Wars. The American elite of 1933 had lived the Great War, watched 1917, and was watching European fascism in real time. The ruptured cases lack it: the Bourbon elite's last internal rupture was the Fronde, some 140 years earlier, beyond any living memory.

**The Romanov and Qing cases identify a third category that is worse than inexperience.** Both had recent, severe internal upheaval—1905 and the Taiping Rebellion respectively—and both *survived it without structural reform*. The lesson each elite drew was that suppression works. Experience of crisis therefore taught precisely the wrong thing, leaving them more confident than the Bourbons rather than less. This generates a specific and non-obvious prediction: **an elite that has recently put down a rising is more likely to rupture than one that has faced none**, because it holds empirical grounds for believing it can hold. Simple ignorance at least produces no false confidence.

This is the Forgetting Loop operating on the variable that determines whether a crisis resolves or ruptures, and it is the same mechanism as vehicle-perception: believing an existential stake requires having seen the downside. It also gives the practical form—what tips an elite toward accommodation is not proximity to conflict but proximity to *losing*. One that won without changing learned that not changing works.
