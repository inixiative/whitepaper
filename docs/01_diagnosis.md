...
**Spatial Complexity as Carrying-Capacity Infrastructure**
...
This has a direct policy implication for human cities: **minimum dwelling sizes in high-density urban environments function as carrying-capacity infrastructure, not luxury regulation.** They are the human equivalent of Calhoun's side rooms. The biological density sensor doesn't read property deeds or understand rent markets — it reads the same cues Calhoun's mice read: how many conspecifics are you encountering in your territory, how much space can you defensibly control, how often are you in involuntary proximity to competitors.

A person in a 200 sq ft studio in a dense city is getting maximum-density signals constantly — shared hallways, packed elevators, crowded streets, no private territory that feels defensible. The sensor fires. Competitive intensity calibration shifts upward. And given the dimorphism of competitive suppression: when female density signals are maximal, fertility suppression is the predicted output. Japan (some of the smallest average dwelling sizes in the developed world, 1.2 fertility), South Korea (extreme density in Seoul plus tiny apartments, 0.72 fertility), and Hong Kong (the smallest average dwelling sizes of any major city, 0.8 fertility) are exactly what the framework predicts.

You can stack people vertically — density itself is not the problem. The problem is density *without spatial complexity*: without enough defensible private territory per individual that the biological sensor reads "I have space" rather than "I'm surrounded by competitors." Minimum unit sizes, access to private outdoor space, acoustic isolation, visual privacy — these are not amenities. They are **signal inputs to the density sensor**. Get them wrong and you trigger the competitive saturation cascade regardless of how wealthy, safe, or materially abundant the society is. Calhoun proved this with mice. We are proving it with cities.
...
**"Education reform"** — The Rockefeller General Education Board's founding document (Occasional Letter No.1, 1906) stated the vision plainly: "In our dreams…people yield themselves with perfect docility to our molding hands...We shall not try to make these people or any of their children into philosophers or men of learning or men of science...The task we set before ourselves is very simple…we will organize children…and teach them to do in a perfect way the things their fathers and mothers were doing in an imperfect way." From this origin to contemporary credentialism, education is framed as creating opportunity and developing human potential. Actual outcomes: standardized curricula optimized for compliance, credentialing that gates access rather than certifies competence, student debt that creates lifelong obligation to employers. The stated purpose (opportunity, development) provided cover for the actual function (workforce conditioning, credential gatekeeping).
