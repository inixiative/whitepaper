...
**The General Principle: Unchecked Competition Destroys Institutions**

This pattern is not unique to women or any specific group. It represents a general principle: **when any group pursues competitive advantage within institutions without bearing costs for institutional decline, institutional function degrades.** Elite men exhibited this for centuries through rentier extraction and regulatory capture (Sections 1.3, 1.7). Women entering saturated institutions exhibit similar dynamics—optimizing for access and competitive position rather than institutional preservation. Identity-based coalitions (DEI mandates, affirmative action quotas) follow the same pattern. The common thread is not gender or identity, but **accountability-free competition**. Any group that can extract benefits while externalizing costs of institutional decay will do so—not from malice, but because individual competitive advantage diverges from collective institutional health.
