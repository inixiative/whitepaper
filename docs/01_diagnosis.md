...
**The one attested reversal, and what it costs.** Every mechanism in this section runs in one direction—toward illegibility, uncorrectably, because the failure selects for its own continuation. There is one condition historically observed to reverse it, and the vehicle/arena account predicts exactly why.
