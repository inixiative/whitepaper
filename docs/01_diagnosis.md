...
**The family-formation displacement effect.** Section 1.2c identified "family structure is irrelevant" as a paradigmatic luxury belief — costless to elites with two-parent households, private tutors, and trust funds, devastating to everyone else. But the damage goes beyond a single policy position. The entire messaging environment these movements produce — the causes, the activism, the identity frameworks, the external-victim narratives — functions as an attention sink that displaces the behaviors that actually predict stability and upward mobility for non-elites. The research is unambiguous: stable two-parent families are the single strongest predictor of children's economic mobility, educational attainment, and psychological wellbeing. Nothing else comes close. Yet the ideological infrastructure described above saturates its participants with messaging that directs energy outward — toward systemic causes, collective grievances, and political mobilization — rather than inward toward the unglamorous, status-neutral work of forming and maintaining families. You cannot simultaneously tell young people that their problems are structural, that family structure doesn't matter, that personal responsibility is a right-wing talking point, and that activism is the path to meaning — and expect them to make the mundane daily sacrifices that stable family formation requires. The messaging is not neutral on family; it is actively corrosive to it. And the people most damaged are not the elites producing the messaging — their families remain intact — but the aspirants and working class who absorb it. This is luxury beliefs operating not as discrete policy positions but as an entire epistemic environment: a sustained redirection of attention from what works to what signals.
