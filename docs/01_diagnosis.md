...
**The monogamy paradox: stability creates the tail.** Monogamous societies solve the male-competition problem at the group level—every man gets a reproductive stake in the system, enabling the cooperation that built civilization. But monogamy channels competition, it doesn't eliminate it. Once a society moves past survival, the competitive energy that polygynous societies spend on direct male-male violence gets redirected into status signaling—and the signaling is no less intense for being culturally mediated. The selection pressure runs in one direction: accumulate. Just as peacocks don't grow shorter tails once they've survived long enough, societies don't shed costly competitive burdens once they've achieved stability. Luxury beliefs are feathers. The burdens are not incidental to the signaling; the burdens *are* the signal, because only those with sufficient resources can bear them. The irony is structural: the same monogamous stability that allows a society to build cathedrals also creates the selection environment where its members compete themselves into demographic collapse, accumulating ever-more-elaborate feathers until the bird can no longer fly.
