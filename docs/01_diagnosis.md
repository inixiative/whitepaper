...
**The demographic cliff (2020s-2030s) compounds this fiscal crisis:** Boomer retirement creates governance strain regardless of which wealth-flow scenario materializes. **Scenario 1 (Zeihan's consumption collapse):** Traditional spending patterns crater as retirees stop working—tax revenue plummets, consumption drops. **Scenario 2 (wealth-in-trusts):** The top 10% (who account for ~50% of consumer spending per Moody's Analytics) use loan-against-assets strategies, maintaining consumption while locking wealth in perpetual trusts—inequality accelerates, tax base erodes. **Scenario 3 (Green's healthcare cost sink):** Accumulated wealth flows to 15+ years of nursing care, pharmaceuticals, end-of-life treatment—the state subsidizes care (Medicare deficits explode), capital consumed by low-productivity healthcare (Baumol's cost disease) rather than productive investment, younger generation inherits nothing while paying taxes to fund prolonged morbidity. All three paths converge: wealth either vanishes (healthcare), concentrates (trusts), or both—while the state faces exploding obligations and collapsing revenue.
